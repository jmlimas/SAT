...
ADMINS = (
     ('Gustavo Reyes', 'gusreyes01@gmail.com'),
     ('Raul Jimenez', 'jimenezjrs@gmail.com'),
     ('Eduardo Lopez', 'elopez.37@gmail.com'),
     ('Rafael Garcia', 'rafagarciafdz@gmail.com'),
)
...
SECRET_KEY = '@yof8l5i8a4#zy#f_y9+0e929fi%ircpmjcm-^peqf#a)9t0n^'
